...
const ImageSummary = ({ images, metaData, prompts, graph, setGraph, graphSchema, handleSuggestionButtonClick, switchChecked, setSwitchChecked, handleNodeEdit, handleNodeAdd, handleNodeRelabel, handleLabelEditSave, groups, setGroups, treeUtils }) => {
                ...
                <div className="right-column">
                    ...
                    <div className="label-view">
                        <div style={{ "display": "flex", "alignItems": "center", "justifyContent": "space-between" }}>
                            ...
                            <i>Generated by Qwen-VL-Max and may contain errors.</i>
                        </div>
