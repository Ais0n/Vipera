            ...
            <div className="content">
                ...
                <div className="right-column">
                    ...
                    <div className="label-view">
                        ...
                        <TreeView images={images} data={graph} handleBarHover={handleBarHover} handleNodeHover={handleNodeHover} handleNodeEdit={handleNodeEdit} handleNodeAdd={handleNodeAdd} addBookmarkedChart={addBookmarkedChart} colorScale={colorScale} highlightTreeNodes={highlightTreeNodes} groups={groups} customColors={customColors} />
                    </div>
                </div>
            </div>
